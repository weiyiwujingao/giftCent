...
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="ibox-content">
            ...
            <form class="form-horizontal m-t-md" id="f1" action="<?php echo e(route('giftGoods.update',$good->id)); ?>" method="post" accept-charset="UTF-8" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-sm-2">
                        <input type="text" class="form-control" name="name" value="<?php echo e($good->name); ?>" required data-msg-required="请输入商品名称">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-sm-2">
                        <input type="text" class="form-control" name="price" value="<?php echo e($good->price); ?>" required data-msg-required="请输入市场价">
                    ...
                    <div class="input-group col-sm-2">
                        <select class="form-control" name="cat_id">
                            <?php $__currentLoopData = $cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($item->id); ?>" <?php if($good->cat_id == $item->id): ?> selected="selected" <?php endif; ?>><?php echo e($item->name); ?></option>
                                <?php $__currentLoopData = $item->cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($cat->id); ?>" <?php if($good->cat_id == $cat->id): ?> selected="selected" <?php endif; ?>>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-sm-1">
                        <select class="form-control" name="status">
                            <option value="1" <?php if($good->status == 1): ?> selected="selected" <?php endif; ?>>正常</option>
                            <option value="2" <?php if($good->status == 2): ?> selected="selected" <?php endif; ?>>下架</option>
                        </select>
                    ...
                    <div class="input-group col-sm-5">
                       <div><label class="btn btn-info" for="uploadipt">选择图片</label> (尺寸：宽600px,高480px)</div>
                        <?php if($errors->has('imgs')): ?>
                            <span class="help-block m-b-none"><i class="fa fa-info-circle"></i><?php echo e($errors->first('imgs')); ?></span>
                        <?php endif; ?>
                       <div id="picbx" style="padding-top: 10px;">
                           <?php if($good->imgs): ?>
                               <img src="<?php echo e($good->imgs); ?>" style="max-height: 300px;">
                               <input type="hidden" name="imgs" value="<?php echo e($good->imgs); ?>">
                           <?php endif; ?>
                       </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-sm-8">
                        <textarea name="content" id="container"><?php echo e($good->content); ?></textarea>
                    </div>
                </div>
                <div class="hr-line-dashed m-t-sm m-b-sm"></div>
                <div class="form-group">
