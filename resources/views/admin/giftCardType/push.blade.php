...
<div class="row">
    <div class="col-sm-12">
        ...
        <div class="ibox-content main" ng-app='app'>
            ...
            <a href="{{route('giftCardType.index')}}"><button class="btn btn-primary btn-sm" type="button"><i class="fa fa-plus-circle"></i> 礼品卡管理</button></a>
            <div class="hr-line-dashed m-t-sm m-b-sm"></div>
            <form class="form-horizontal m-t-md" action="{{ route('giftCardType.addCard',$info->id) }}" method="post" accept-charset="UTF-8" enctype="multipart/form-data">
                {!! csrf_field() !!}
                {{method_field('PATCH')}}
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-sm-2" ng-controller='controller'>
                        <input  class="form-control" size="18" type="text" name="start_time" id="start_time" onclick="clearDefaultText(this,'start_time')" required data-msg-required="请输入礼品卡开始时间"/>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group col-sm-2" ng-controller='controller'>
                        <input  class="form-control" size="18" type="text" name="end_time" id="end_time" onclick="clearDefaultText(this,'end_time')" required data-msg-required="请输入礼品卡结束时间"/>
...
<script src="{{loadEdition('/js/angular.min.js')}}"></script>
<script src="{{loadEdition('/js/jquery.datetimepicker.js')}}"></script>
